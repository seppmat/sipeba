...
<?php 
    ...
    <div class="container">
        ...
        <div class="wrapper">
            ...
            <a href="data_peminjaman.php" class="now">Data Peminjaman</a>
        ...
        <div class="content">
            <div class="table">
                ...
                while ($data = mysqli_fetch_array ($sql)){
                    ...
                    echo "<td><a href ='edit_data.php?nomor=" . $data['nomor'] . "'>Edit</a></td>";
                    echo "<td><a href ='delete_data.php?nomor=" . $data['nomor'] . "'>Delete</a></td>";
                    echo "<tr>";
                }
?>
