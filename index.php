            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto" >
                  ...
                  <!-- <span class="d-none d-lg-block">SIPEBA</span> -->
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your email & password to log in</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="login.php" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="indexreg.php">Create an account</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                Designed by <a href="https://seppmat.github.io/">Sepp</a>
              </div>
