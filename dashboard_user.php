...
?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="formulir.php">
          <i class="bi bi-person"></i>
          <span>Formulir</span>
        </a>
      </li><!-- End Tables Nav -->
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h3>Anggota <?php echo $_SESSION['bidang']; ?></h3>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password" disabled>Change Password</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 20px" name="tujuan_peminjaman" disabled></textarea>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['npp']; ?></div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Bidang/Divisi</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['bidang']; ?></div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <a title="Upload new profile image"><input type="file" style = "opacity: 1; width: 105px;"></i></a>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo $_SESSION['username']; ?>">
                      </div>
                    </div>
